      ...
      {(internalNotes || isEditing) && (
        <div className="space-y-3">
          <textarea
            ...
            className="w-full p-3 border border-gray-300 rounded-lg text-sm resize-none focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent bg-white nodrag nowheel"
